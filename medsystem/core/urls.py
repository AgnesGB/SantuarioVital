...
urlpatterns = [
    ...
    path(
        "usuario/<int:usuario_id>/alterar-tipo/", alterar_tipo_usuario, name="alterar-tipo-usuario"
    ),
    # Doenças
    ...
    # Diagnósticos
    path(
        "pacientes/<int:paciente_id>/diagnostico/",
        DiagnosticoCreateView.as_view(),
        name="diagnostico-create",
    ),
    path(
        "pacientes/<int:paciente_id>/adicionar-diagnostico/",
        AdicionarDiagnosticoView.as_view(),
        name="adicionar-diagnostico",
    ),
    path("diagnostico/<int:pk>/", DiagnosticoDetailView.as_view(), name="diagnostico-detail"),
    path(
        "diagnosticos/<int:pk>/editar/", DiagnosticoUpdateView.as_view(), name="diagnostico-update"
    ),
    path(
        "diagnosticos/<int:pk>/excluir/", DiagnosticoDeleteView.as_view(), name="diagnostico-delete"
    ),
    # Registros Médicos
    ...
    path(
        ...
        RelatorioExpedicaoUpdateView.as_view(),
        name="relatorio-update",
    ),
    path(
        "relatorios/<int:pk>/excluir/",
        RelatorioExpedicaoDeleteView.as_view(),
    ...
    path(
        "ingredientes/<int:pk>/editar/", IngredienteUpdateView.as_view(), name="ingrediente-update"
    ),
    path(
        "ingredientes/<int:pk>/excluir/", IngredienteDeleteView.as_view(), name="ingrediente-delete"
    ),
