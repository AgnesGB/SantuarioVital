...
class PacienteForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "nome": forms.TextInput(attrs={"class": "input"}),
            "idade": forms.NumberInput(attrs={"class": "input", "min": "0", "max": "150"}),
            "raca": forms.SelectMultiple(attrs={"class": "select"}),
            "afinidade": forms.Select(attrs={"class": "select"}),
            "fay_normal": forms.TextInput(
                attrs={
                    "class": "input",
                    "placeholder": "💡 Ex: Luz, Fogo, Água, Terra, Ar, Trevas...",
                }
            ),
...
class RegistroMedicoForm(forms.ModelForm):
    sintomas_observados = forms.CharField(
        widget=forms.Textarea(
            attrs={"class": "textarea", "rows": 3, "placeholder": "Descreva os sintomas observados"}
        ),
        required=True,
    )
    ...
    class Meta:
        ...
        widgets = {
            ...
            "observacoes": forms.Textarea(
                attrs={"class": "textarea", "rows": 3, "placeholder": "Anotações adicionais"}
            ),
    ...
    class Meta:
        ...
        widgets = {
            ...
            "tags": forms.TextInput(
                attrs={"class": "input", "placeholder": "palavra-chave1, palavra-chave2, ..."}
            ),
        }
    ...
    class Meta:
        ...
        widgets = {
            ...
            "quantidade": forms.TextInput(
                attrs={"class": "input", "placeholder": "Ex: 2 colheres, 100g, 5 gotas"}
            ),
        }
